...
knitr::include_graphics(here("figures", "partners_png.png"))
```
...
knitr::include_graphics(here("figures", "special_housing.png"))
```
...
knitr::include_graphics(here("figures", "relocation_id.png"))
```
